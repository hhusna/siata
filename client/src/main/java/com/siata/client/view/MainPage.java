...
public enum MainPage {
    ...
    RECAPITULATION("📋", "Rekapitulasi", "Rabu, 8 Oktober 2025", "Ringkasan dan matriks distribusi aset", null),
    ASSET_MANAGEMENT("📦", "Aset", "Sabtu, 11 Oktober 2025", "Kelola data aset pegawai", null),
    EMPLOYEE_MANAGEMENT("👥", "Pegawai", "Rabu, 8 Oktober 2025", "Kelola data pegawai dan aset yang dimiliki", null),
