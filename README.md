...
```
cd existing_repo
git remote add origin https://git.stis.ac.id/kelompok-6-rpl/siata.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.stis.ac.id/kelompok-6-rpl/siata/-/settings/integrations)
